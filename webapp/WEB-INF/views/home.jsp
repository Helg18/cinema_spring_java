...
<html lang="en">
  <head>
    ...
    <meta name="description" content="Sitio para la reserva de cine">
    <meta name="author" content="Henry Leon">
        ...
        <div class="row">
			...
			<c:forEach items="${peliculas}" var="pelicula">
				<div class="col-xs-12 col-sm-6 col-md-3">
		            <img class="img-rounded" src="${urlPublic}/images/${pelicula.image}" alt="Generic placeholder image" width="150" height="200">
		            ...
		            <p><a class="btn btn-sm btn-primary" href="detail/${pelicula.id}/${fechaActual}" role="button">Consulta Horarios &raquo;</a></p>
		          </div>
			</c:forEach>
